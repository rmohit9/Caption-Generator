            ...
            <div className="flex gap-3">
              {[
                ...
                { 
                  ...
                  label: "Facebook",
                  url: "https://www.facebook.com/Graphura.in?rdid=J0a5UgQ0vbG2mTMp&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F19nKAMTopZ%2F#"
                },
              ].map((s) => (
                <a
                  key={s.label}
              ...
              <ul className="space-y-3">
                {col.title === "Quick Links" ? (
                  ...
                  <>
                    ...
                    <li>
                      <a
                        href="https://www.facebook.com/Graphura.in?rdid=J0a5UgQ0vbG2mTMp&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F19nKAMTopZ%2F#"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-sm text-orange-700/60 hover:text-orange-600 font-semibold transition-colors hover:translate-x-1 inline-block transition-transform"
                      >
        ...
        <div className="border-t border-orange-200/60 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-xs">
              <span className="text-black">&copy; 2025 </span>
