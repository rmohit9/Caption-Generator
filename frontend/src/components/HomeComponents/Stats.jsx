...
import { HiOutlineDocumentText, HiOutlineSparkles, HiOutlineClock, HiOutlineChartBar } from "react-icons/hi2";
...
export default function Stats() {
  return (
    <section className="relative z-10 py-14 px-4 bg-gradient-to-r from-pink-600 via-purple-600 to-indigo-600">
      {/* Subtle hashtag pattern overlay */}
      <div
