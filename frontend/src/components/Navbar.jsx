    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex gap-3 lg:gap-4 items-center">
          {user ? (
            <>
              <span className="text-sm font-semibold text-pink-700 truncate max-w-[180px]">
                {user.user_metadata?.full_name || user.email}
              </span>
              <button
                onClick={async () => { await signOut(); navigate("/login"); }}
                className="px-4 py-2 text-sm lg:text-base font-semibold text-pink-700 border-2 border-pink-200 rounded-full bg-white/50 backdrop-blur-sm hover:bg-pink-50 hover:scale-110 transition-all duration-400 shadow-sm hover:shadow-md cursor-pointer"
              >
                Logout
              </button>
            </>
              ...
              {user ? (
                <>
                  ...
                  <button
                    ...
                    className="px-4 py-2 text-sm font-semibold text-pink-700 border-2 border-pink-200 rounded-full bg-white/50 backdrop-blur-sm hover:bg-pink-50 transition-all cursor-pointer"
                  >
                    Logout
                  </button>
                </>
