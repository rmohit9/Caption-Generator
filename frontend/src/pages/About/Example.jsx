...
const toggleHashtag = (tag) => {
    ...
    return (
      ...
      `}</style>
            ...
            <section className="relative py-20 px-4 z-10 overflow-hidden bg-white/50 backdrop-blur-sm">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-indigo-50/30 via-white to-pink-50/30" />
                ...
                <div className="relative max-w-4xl mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
                        <button className="group relative overflow-hidden px-8 py-4 bg-gradient-to-r from-indigo-600 to-pink-600 text-white font-black rounded-full text-lg shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
